...
def main() -> int:
    ...
    # Chronology is deliberate: retrieve current primary documentation and
    # resolve exact package versions before emitting package.json or source.
    ...
    generation = {
        "schema": "davidanderle.r7e.source-generation.v4",
        "generatedAtUtc": base.now(),
        "builder": "r7e/reference_builder_v4.py",
        "baseBuilder": "r7e/reference_builder_v1.py",
        "patchSet": "r7e/template_patch_v4.py",
        "python": sys.version,
