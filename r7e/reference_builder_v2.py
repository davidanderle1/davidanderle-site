...
from template_patch_v2 import apply_v2_patches
...
def main() -> int:
    ...
    generation = {
        "schema": "davidanderle.r7e.source-generation.v2",
        "generatedAtUtc": base.now(),
        "builder": "r7e/reference_builder_v2.py",
        "baseBuilder": "r7e/reference_builder_v1.py",
        "patchSet": "r7e/template_patch_v2.py",
        "python": sys.version,
    ...
    print(json.dumps({"output": str(output), "files": manifest["files"], "bytes": manifest["bytes"], "treeSha256": manifest["treeSha256"], "versions": versions, "patchSet": "v2"}, indent=2))
    return 0
