...
from template_patch_v5 import apply_v5_patches
...
def main() -> int:
    ...
    generation = {
        "schema": "davidanderle.r7e.source-generation.v5",
        "generatedAtUtc": base.now(),
        "builder": "r7e/reference_builder_v5.py",
        "baseBuilder": "r7e/reference_builder_v1.py",
        "patchSet": "r7e/template_patch_v5.py",
        "python": sys.version,
